...
<!--      <li class="nav-item">
          <a class="nav-link" href="student_online_clerance_system/MDB-Free_4.8.2\LoginPage.php">Logout</a>
      </li>-->
...
<!--/.Navbar-->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img class="d-block w-100" src="blackimage.jpg"
        alt="First slide">
    </div>
    <div class="carousel-item">
        <img class="d-block w-100" src="black2.jpg"
        alt="Second slide">
    </div>
    <div class="carousel-item">
        <img class="d-block w-100" src="0.jpg"
        alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
     ...
     <!--/.carosoul-->
            ...
            <h2 text-align="center">Online Student Clearance System</h2>
